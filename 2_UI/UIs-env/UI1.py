...
class FluorimetroUI(QMainWindow):
    ...
    def init_config_tab(self):
        ...
        self.combo_port.addItems(["COM1", "COM2", "COM3", "COM4"]) # Aquí se pueden autodetectar luego
        
        # Selector de Bauds
        self.combo_baud = QComboBox()
        self.combo_baud.addItems(["9600", "57600", "115200"])
        self.combo_baud.setCurrentText("115200") # Por defecto a la velocidad de tu Arduino

        # Botón de Conexión
        self.btn_connect = QPushButton("Conectar")
        self.btn_connect.setStyleSheet("background-color: #4CAF50; color: white; font-weight: bold; padding: 5px;")
    ...
    def init_gui_tab(self):
        ...
        # Placeholder para un futuro botón de encendido/apagado del LED
    ...
    def update_led_label(self, value):
        ...
        # Aquí enviarás el valor por puerto serial al Arduino en el futuro.
        # Ejemplo: self.serial_port.write(f"LED:{value}\n".encode())

    def update_plot(self, json_data_string):
        """
        Esta función se llamará cada vez que recibas datos del Arduino.
        json_data_string: String con el formato '{"415nm": 5000, "445nm": 200...}'
        """
        try:
            data = json.loads(json_data_string)
            # Extraemos los valores en el mismo orden que self.wavelengths
            # Asumimos que las llaves en tu diccionario son, por ejemplo, "415nm"
            y_values = [
            ...
            # Actualizamos el gráfico de forma ultra rápida
...
if __name__ == '__main__':
    ...
    app.setStyle("Fusion") # Estilo moderno y limpio para Windows/Linux/Mac
